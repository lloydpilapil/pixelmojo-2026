...
export function BlogCTA({
  ...
  return (
    <div
      className={cn(
        'bg-muted/50 border border-border/60 rounded-lg overflow-hidden w-full',
        className
      )}
    >
      ...
      <div className='p-6'>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            <div>
              <input
                ...
                required
                className='w-full px-4 py-3 border border-border/60 rounded-lg bg-background text-foreground focus:ring-2 focus:ring-primary focus:border-primary transition-colors text-sm'
              />
            </div>
            <Button
              type='submit'
        ...
        {variant === 'contact' && (
          <div className='text-center'>
            <Button variant='default' shape='pill' className='w-full'>
              {buttonText}
            </Button>
          </div>
        )}

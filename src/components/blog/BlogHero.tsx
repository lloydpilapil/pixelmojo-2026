    ...
    <div className={cn('w-full bg-background', className)}>
      <div className='container mx-auto px-4 py-16'>
        <header className='max-w-6xl mx-auto text-center'>
          {/* Date */}
          <time className='text-muted text-small mb-4 block'>
            {formattedDate}
            {readingTime && (
              <>
          ...
          {/* Title */}
          <h1 className='blog-hero-title max-w-5xl mx-auto'>{title}</h1>
          
          {description && (
            <p className='text-large text-muted-foreground mb-8 leading-relaxed max-w-4xl mx-auto'>
              {description}
            </p>
          )}
          ...
          {author && (
            <div className='flex items-center justify-center gap-3 mb-8'>
              ...
              <span className='text-small text-muted-foreground'>by {author.name}</span>
            </div>
          )}

...
export const metadata: Metadata = {
  title: 'Works | Lloyd Pilapil',
  description: 'Explore my works and web development projects including full-stack applications, React components, and modern web solutions.',
  openGraph: {
    title: 'Lloyd Pilapil - Works',
    description: 'Explore my works and web development projects.',
    type: 'website',
  },
}
    ...
    <div className='container mx-auto px-4 py-16 animate-fade-in'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-20'>
          <h1 className='mb-6 font-heading'>My Works</h1>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20'>
          {projects.map(project => (
            ...
            >
              ...
              {/* Project Content */}
              <div className='p-6'>
                <h3 className='mb-3 font-heading group-hover:text-primary transition-colors'>{project.title}</h3>
        ...
        <section className='text-center bg-muted/30 rounded-2xl p-12'>
          <h2 className='mb-6 font-heading'>Ready to Work Together?</h2>

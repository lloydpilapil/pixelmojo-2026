            ...
            <div className='grid gap-8 md:grid-cols-2 text-left'>
              ...
              >
                ...
                <p
                  ...
                  style={{ color: theme.mutedTextColor }}
                >
                  Decks fall flat, visuals stall in review, and founders rewrite
                  copy at midnight. We blend brand voice, sales enablement, and
                  analytics so every asset nudges a deal forward.
                </p>
              </div>
              <div
                className='rounded-xl border p-8 space-y-4'
              ...
              >
                ...
                >
                  <li>
                    Jasper + Claude draft narratives that our editors tighten in
                    minutes.
                  </li>
                  <li>

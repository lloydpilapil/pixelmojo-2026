      ...
      <div className='max-w-4xl mx-auto'>
        <div className='text-center mb-16'>
          ...
          <p className='lead max-w-2xl mx-auto'>
            Explore our design system components with various states and
            variants.
          </p>
        </div>
          ...
          <div className='space-y-8'>
            ...
            <div className='card p-6'>
              ...
              <div className='flex flex-wrap items-center gap-4'>
                ...
                <Button size='default' shape='pill'>
                  Default
                </Button>
        ...
        <section className='mb-16'>
          ...
          <div className='space-y-8'>
            ...
            <div className='card p-6'>
              ...
              <div className='flex flex-wrap gap-4'>
                <Button shape='pill' className='flex items-center gap-2'>
                  <svg
                    className='w-4 h-4'
                    fill='none'
                    stroke='currentColor'
            ...
            <div className='card p-6'>
              ...
              <div className='flex flex-wrap gap-4'>
                <Button shape='pill'>Normal</Button>
                <Button shape='pill' disabled>
                  Disabled
                </Button>
                <Button shape='pill'>Loading</Button>
              </div>
            </div>
            ...
            <div className='card p-6'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <div className='flex gap-3'>
                  ...
                  <Button shape='pill'>Publish</Button>
                </div>
              </div>
            </div>
          </div>

...
<BlogTable
  data={{
    ...
    rows: [
      ...
      [
        'Revision Rate (rounds)',
        '3.2-4.5 avg [our data]',
        '2.5-3.5 avg',
        '1.4-2.1 avg [our data]',
      ],
      [
        'QA Coverage',
        '60-75% (manual)',
        '70-85% (semi-automated)',
        '90-98% (AI+human)',
      ],
      [
        'Cost Structure',
      ...
      [
        'Best For',
        'Complex stakeholder orgs',
        'Mid-market flexibility needs',
        'Speed, efficiency, data-driven',
      ],
    ],
  }}
/>
